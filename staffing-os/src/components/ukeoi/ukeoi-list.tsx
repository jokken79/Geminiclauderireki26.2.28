...
import type { UkeoiListItem } from "@/actions/ukeoi"
import { ASSIGNMENT_STATUS_LABELS } from "@/lib/constants"
import type { AssignmentStatus } from "@prisma/client"

const columns: ColumnDef<UkeoiListItem, unknown>[] = [
  {
  ...
  {
    accessorKey: "internalSupervisor",
    header: "現場責任者",
  },
  {
  ...
  },
  {
    ...
    enableSorting: false,
    cell: ({ row }) => (
      <Link href={`/ukeoi/${row.original.id}`}>
